...
class AIzymes_MAIN:
    ...
    def setup(self, FOLDER_HOME, FOLDER_PARENT, CST_NAME, WT, LIGAND, DESIGN,
              ...
              SUBMIT_PREFIX=None, SYSTEM=None, MATCH=None, ROSETTA_PATH="/home/bunzelh/rosetta_src_2021.16.61629_bundle/main/source/",
              EXPLORE=False, FIELD_TOOLS='src/FieldTools.py', LOG='debug', PARENT_DES_MED='RosettaDesign'):
        """
