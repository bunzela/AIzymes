...
def load_plot_scores_df(self):
    ...
    self.plot_scores_df = self.all_scores_df.dropna(subset=['total_score'])
...
def plot_statistics(self):
    ...
    finished_count = self.all_scores_df['total_score'].notna().sum()
    crashed_count = 0
    ...
    plt.tight_layout()
    save_path = os.path.join(self.FOLDER_HOME, "plot_statistics.png")
...
def plot_scores_v_index(self):
    ...
    plt.tight_layout()
    save_path = os.path.join(self.FOLDER_HOME, "plot_scores_v_index.png")
    fig.savefig(save_path, bbox_inches='tight')
    plt.close(fig)
...
def plot_scores_v_generation(self):
    ...
    plt.tight_layout()
    save_path = os.path.join(self.FOLDER_HOME, "plot_scores_v_generation.png")
    fig.savefig(save_path, bbox_inches='tight')
    plt.close(fig)
...
def plot_mutations_v_generation(self):
    ...
    plt.tight_layout()
    save_path = os.path.join(self.FOLDER_HOME, "plot_mutations_v_generation.png")
    fig.savefig(save_path, bbox_inches='tight')
    plt.close(fig)
...
def print_vals(self):
    ...
    plt.tight_layout()
    save_path = os.path.join(self.FOLDER_HOME, "print_vals.png")
    fig.savefig(save_path, bbox_inches='tight')
    plt.close(fig)
...
def combine_images(self):
    ...
    file_paths = [os.path.join(self.FOLDER_HOME, name) for name in file_names]
    ...
    combined_path = os.path.join(self.FOLDER_HOME, "results.png")
...
def plot_resource_log(self):
    ...
    plt.tight_layout()
    save_path = os.path.join(self.FOLDER_HOME, "resource_log_performance.png")
    fig.savefig(save_path, bbox_inches='tight')
    plt.close(fig)
